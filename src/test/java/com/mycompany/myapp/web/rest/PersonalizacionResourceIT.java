...
class PersonalizacionResourceIT {
    ...
    void putExistingPersonalizacion() throws Exception {
        ...
        updatedPersonalizacion.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).idCatedra(UPDATED_ID_CATEDRA);
    ...
    void fullUpdatePersonalizacionWithPatch() throws Exception {
        ...
        partialUpdatedPersonalizacion.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).idCatedra(UPDATED_ID_CATEDRA);
