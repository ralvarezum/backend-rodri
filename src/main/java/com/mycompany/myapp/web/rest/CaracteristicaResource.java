...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Caracteristica}.
 */
@RestController
...
public class CaracteristicaResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<CaracteristicaDTO> createCaracteristica(@RequestBody CaracteristicaDTO caracteristicaDTO)
