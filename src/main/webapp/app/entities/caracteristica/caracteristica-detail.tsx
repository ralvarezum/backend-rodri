    ...
    <Row>
      <Col md="8">
        <h2 data-cy="caracteristicaDetailsHeading">
          <Translate contentKey="backendRodriApp.caracteristica.detail.title">Caracteristica</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{caracteristicaEntity.idCatedra}</dd>
          <dt>
            <Translate contentKey="backendRodriApp.caracteristica.dispositivo">Dispositivo</Translate>
          </dt>
