...
export const CaracteristicaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="backendRodriApp.caracteristica.delete.question">
        <Translate contentKey="backendRodriApp.caracteristica.delete.question" interpolate={{ id: caracteristicaEntity.id }}>
