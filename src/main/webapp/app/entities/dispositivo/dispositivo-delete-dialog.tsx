...
export const DispositivoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="backendRodriApp.dispositivo.delete.question">
        <Translate contentKey="backendRodriApp.dispositivo.delete.question" interpolate={{ id: dispositivoEntity.id }}>
