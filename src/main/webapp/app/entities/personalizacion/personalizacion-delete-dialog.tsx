...
export const PersonalizacionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="backendRodriApp.personalizacion.delete.question">
        <Translate contentKey="backendRodriApp.personalizacion.delete.question" interpolate={{ id: personalizacionEntity.id }}>
