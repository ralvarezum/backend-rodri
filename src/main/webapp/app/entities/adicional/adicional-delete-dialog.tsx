...
export const AdicionalDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="backendRodriApp.adicional.delete.question">
        <Translate contentKey="backendRodriApp.adicional.delete.question" interpolate={{ id: adicionalEntity.id }}>
